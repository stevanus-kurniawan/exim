...
export function validateCreateShipmentBody(
  ...
  if (body?.etd != null && parseDate(body.etd)) data.etd = typeof body.etd === "string" ? body.etd : String(body.etd);
  if (body?.eta != null && parseDate(body.eta)) data.eta = typeof body.eta === "string" ? body.eta : String(body.eta);
